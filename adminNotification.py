...
class MyApp:
    ...
    def open_notification_window(self):
        ...
        tk.Label(self.notification_frame, text="Title:", font=("Arial", 12, "bold"), bg="#EDEDED").pack()
        self.title_text = tk.Entry(self.notification_frame, font=("Arial", 12),borderwidth=4,relief=SUNKEN)
        self.title_text.pack()

        tk.Label(self.notification_frame, text="Message:", font=("Arial", 12, "bold"), bg="#EDEDED").pack()
        self.message_text = Text(self.notification_frame, font=("Arial", 12),wrap="word" ,height=10, width=40,borderwidth=4,relief=SUNKEN)
        ...
        tk.Checkbutton(self.notification_frame, text="Faculty", variable=self.faculty_var, font=("Arial", 12),
                       bg="#EDEDED").pack()
    ...
    def show_notifications(self):
        ...
        cursor = self.db_connection.cursor()
        cursor.execute("SELECT title, message, recipients, date FROM notifications ORDER BY date DESC")
        ...
        for i, notification in enumerate(notifications, start=1):
            ...
            tk.Label(notifications_frame, text=f"Recipients: {notification[2]}", font=("Arial", 12, "italic"),
                     bg="#d4d4d4", fg='black', width=40,wraplength=300).pack()
            tk.Label(notifications_frame, text=f"Message: {notification[1]}", font=("Arial", 12, "italic"),
                     bg="#d4d4d4", fg='black', width=40, wraplength=300).pack()
